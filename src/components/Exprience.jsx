...
function Exprience() {
    ...
    return (
        <div className='flex bg-gray-100'>
            <div className='secondHeroSection  flex items-center justify-center w-[50%] py-[10rem] h-auto'>
                <div className='flex text-white gap-5 flex-col items-center justify-center text-center px-4'>
                    {/* Heading Section */}
                    <h1 className='font-bold text-2xl md:text-3xl lg:text-4xl w-full max-w-[65rem]'>
